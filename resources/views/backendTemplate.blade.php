...
<html lang="en">
  <head>
    ...
    <!-- datatable -->
    {{-- <link rel="shortcut icon" href="{{asset('backend/datatables/dataTables.bootstrap4.min.css')}}" /> --}}
    <link rel="shortcut icon" href="{{asset('backend/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}" />
  </head>
  <body>
          ...
          <li class="nav-item">
            <div class="d-flex sidebar-profile">
              <div class="sidebar-profile-image">
                <img src="{{asset('backend/images/faces/face29.png')}}" alt="image">
    ...
    <script type="text/javascript" src="{{asset('backend/js/data-table.js')}}"></script>
    <script src="{{asset('backend/vendors/datatables.net/jquery.dataTables.js')}}"></script>
    <script type="text/javascript" src="{{asset('backend/vendors/datatables.net-bs4/dataTables.bootstrap4.js')}}"></script>
